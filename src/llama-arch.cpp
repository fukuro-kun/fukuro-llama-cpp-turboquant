...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_EMBEDDING_LENGTH_BACKBONE,         "%s.n_embd_backbone"                   },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_FC,                                     "fc" },
    { LLM_TENSOR_D2T,                                    "d2t" },
    { LLM_TENSOR_ENC_LAYER_OUT_SCALE,                    "enc_layer_out_scale" },
    { LLM_TENSOR_SC_PRE_NORM,                            "sc_pre_norm" },
    { LLM_TENSOR_SC_GATE,                                "sc_gate" },
    { LLM_TENSOR_SC_UP,                                  "sc_up" },
    { LLM_TENSOR_SC_DOWN,                                "sc_down" },
};
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_SC_PRE_NORM,                {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},
    {LLM_TENSOR_SC_GATE,                    {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},
    {LLM_TENSOR_SC_UP,                      {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},
    {LLM_TENSOR_SC_DOWN,                    {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},
};
