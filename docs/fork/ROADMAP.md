...
| 19 | 🔬 | Expected Attention KV Cache Compression | Alle | 4-6 Wochen | arXiv:2510.00636 | Phase 1 ✅ | ergänzt TurboQuant — **Phase 1 CPU Math implementiert 2026-07-15: `src/llama-expected-attention.{h,cpp}` + 12 Unit-Tests (135 Assertions, alle grün). Rolling buffer, mean/covariance, RoPE rotation, E(A) score, vnorm, compression decision. Phase 2 (KV-Cache Integration) ausstehend.** |
