...
| 37 | ✅ | LFRU Expert Caching | Styx, Hydra | 2-4 Wochen | vLLM commit 71ed1fc | — | +5.2% speedup, 15-20% hit rate — **Eval 2026-07-13: thecodacus Prefetch repariert (MUL_MAT_ID Graph-Suche). +28.9% pp512, +31% pp2048 auf Styx mit 2-Slot Prefetch. tg8 +2.1% (keine Regression mit 2 Slots!). 1-Slot: +9.8% tg aber -11.9% pp (kein Overlap). 3-Slot: identisch zu 2-Slot. Mars (Vulkan): +8.6% pp aber -35% tg — Prefetch auf Mars nicht empfohlen. Expert-Cache postponed (Buffer-Recycling-Crash). Styx-Server-Script: GGML_SCHED_PREFETCH_SLOTS=2 (Sweet-Spot).** |
