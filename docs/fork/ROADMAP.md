...
| 37 | ⏭️ | LFRU Expert Caching | Styx, Hydra | 2-4 Wochen | vLLM commit 71ed1fc | — | +5.2% speedup, 15-20% hit rate — **Eval 2026-07-13: Postponed. Root Cause gefunden: (1) Expert-Weights haben korrekt WEIGHTS-Usage (nicht COMPUTE wie zuerst vermutet). (2) Selektiver Kopierpfad war broken: nodes[0] war SCALE nicht MUL_MAT_ID — gefixt (Graph-Suche). (3) thecodacus Prefetch funktioniert jetzt! +28% pp512, +31% pp2048 auf Styx. (4) Expert-Cache crasht durch Buffer-Recycling. (5) op_offload mit threshold=1: -37% auf Pascal (Copy-Overhead > CPU-Compute). Cache-Infrastruktur bleibt im Code, Postponed bis Buffer-Pinning oder Per-Expert Tensor-Splitting.** |
