...
| Repository | Refactor `994118a18`? | Architektur |
|------------|----------------------|-------------|
| `ggml-org/llama.cpp` | ✅ Ja | `llama_model_base`-Klassenhierarchie |
| `TheTom/llama-cpp-turboquant` | ❌ Nein | Monolithisch |
| `AtomicBot-ai/atomic-llama-cpp-turboquant` | ✅ Ja (sehe Sync 2026-06-19) | `llama_model_base`-Klassenhierarchie |
| `fukuro-llama-cpp-turboquant` | ✅ Ja (via Sync-Merge) | `llama_model_base`-Klassenhierarchie |
