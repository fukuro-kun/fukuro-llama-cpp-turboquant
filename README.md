...
- **This fork — Vulkan APU GPU-Hang Fix:** `nodes_per_submit=10` for UMA devices prevents `amdgpu.lockup_timeout` (2000 ms) GPU ring resets on AMD APUs. Fixes GPU hangs at large contexts (≥186k) and prompt sizes (≥16384). Enables full context range up to 262k on AMD 760M (RADV PHOENIX) — 223× tg improvement at 188k (0.099 → 22.09 t/s). See [docs/fork/2026-06-21_VULKAN_GPU_HANG_ROOT_CAUSE.md](docs/fork/2026-06-21_VULKAN_GPU_HANG_ROOT_CAUSE.md).
