#!/usr/bin/env bash
# ============================================================================
# Gemma-4 12B IQ4_NL + IQ4_XS Draft MTP-Server auf Legacy-System
# ============================================================================
# OpenAI-kompatible API + Web-Browser parallel nutzbar
#
# Endpunkte:
#   OpenAI API:  http://legacy-system:18080/v1/chat/completions
#   Web-Browser: http://legacy-system:18080/
#   Health:      http://legacy-system:18080/health
#
# Verwendung:
#   ./scripts/run-gemma4-12b-iq4nl-legacy-server.sh
#
# Beispiel API-Request:
#   curl http://legacy-system:18080/v1/chat/completions \
...
# Legacy-System-spezifische Pfade
...
echo "=== Gemma-4 12B MTP-Server auf Legacy-System ==="
echo "Target: $MAIN"
echo "Draft:  $DRAFT"
